...
class addIEButton(OpenMayaMPx.MPxCommand):
    ...
    def CallMenu(self):
        ...
        def importFunc(self):
            ...
            temp = cmds.file(totalPathName, type="OBJ", i=True, rdn=True, mbl=True, mnc=True, rpr=":", op="mo=0",
                             ifr=True, itr="combine")

        def exportFunc(self):
            totalPathName = path + "/" + "TempObject"
            cmds.file(totalPathName, f=True, op="groups=1;ptgroups=1;materials=1;smoothing=1;normals=1",
        ...
        def updateFunc(self):
            ...
            cmds.file(totalPathName, type="OBJ", i=True, rdn=True, mbl=True, mnc=True, rpr=":", op="mo=0", ifr=True,
                      itr="combine")
